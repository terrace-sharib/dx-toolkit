...
if __name__ == '__main__':
    ...
    if 'DXTEST_FULL' not in os.environ:
        if 'DXTEST_INTEGRATION' not in os.environ:
            sys.stderr.write('WARNING: neither env var DXTEST_FULL nor DXTEST_INTEGRATION are set; tests that create apps will not be run\n')
