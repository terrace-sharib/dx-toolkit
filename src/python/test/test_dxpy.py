...
class TestPrettyPrint(unittest.TestCase):
    def test_string_escaping(self):
        self.assertEqual(pretty_print.escape_unicode_string(b"a"), "a")
        self.assertEqual(pretty_print.escape_unicode_string(b"foo\nbar"), "foo\\nbar")
        self.assertEqual(pretty_print.escape_unicode_string(b"foo\x11bar"), "foo\\x11bar")
        self.assertEqual(pretty_print.escape_unicode_string(b"foo\n\t\rbar"), "foo\\n\\t\\rbar")
        self.assertEqual(pretty_print.escape_unicode_string(b"\n\\"), "\\n\\\\")
