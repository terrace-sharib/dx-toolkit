...
def get_auth_server_name(host_override=None, port_override=None):
    ...
    if host_override is not None or port_override is not None:
        ...
        if os.environ.get("DX_AUTHSERVER_HOST") is None or os.environ.get("DX_AUTHSERVER_PORT") is None:
            ...
            return os.environ.get("DX_AUTHSERVER_HOST") + ":" + os.environ.get("DX_AUTHSERVER_PORT")
    else:
